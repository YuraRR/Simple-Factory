...
const allItems = [
  {
    ...
    src: "img/buttonIcons/ironOre-icon.svg",
    price: 10,
  },
  {
    name: "Raw Copper Ore",
    processingIn: "oreProcessing",
    src: "img/buttonIcons/noItem.svg",
    price: 10,
  },
  {
    name: "Refined Iron Ore",
    processingIn: "smelter",
    src: "img/buttonIcons/RefinedIronOre.svg",
    price: 20,
  },
  {
    name: "Refined Copper Ore",
    processingIn: "smelter",
    src: "img/buttonIcons/copperOre-icon.svg",
    price: 20,
  },
  {
    name: "Iron Ingot",
    processingIn: "assembler",
    src: "img/buttonIcons/ironIngot.svg",
    price: 40,
  },
  {
    name: "Iron Plate",
  ...
  { name: "Iron Rod", processingIn: "assembler", src: "img/buttonIcons/ironIngot.svg", price: 40 },
  {
    name: "Copper Ingot",
    processingIn: "assembler",
    src: "img/buttonIcons/copperIngot.svg",
    price: 40,
  },
];
//BUIDINGS LIST
...
const allProcessingOreRecipes = [
  {
    ...
    materialImage: "img/buttonIcons/ironOre-icon.svg",
    materialAmount: 2,
    productImage: "img/buttonIcons/refinedIronOre.svg",
    productAmount: 1,
  },
  {
    productName: "Refined copper ore",
    materialName: "Raw Copper Ore",
    materialImage: "img/buttonIcons/copperOre-icon.svg",
    materialAmount: 2,
    productImage: "img/buttonIcons/copperIngot.svg",
    productAmount: 1,
  },
];
const allSmeltingRecipes = [
  {
    ...
    materialImage: "img/buttonIcons/refinedIronOre.svg",
    materialAmount: 2,
    productImage: "img/buttonIcons/ironIngot.svg",
    productAmount: 1,
  },
  {
  ...
  },
  {
    ...
    productSubtype: "Plates",
    materialName: "Refined Iron Ore",
    materialImage: "img/buttonIcons/refinedCopperOre.svg",
    materialAmount: 2,
    productImage: "img/buttonIcons/copperIngot.svg",
    productAmount: 1,
  },

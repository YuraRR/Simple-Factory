...
(function (window) {
  ...
  var dialog = (function () {
    var //holds the list of used keys.
      ...
      isSafari =
        window.navigator.userAgent.indexOf("Safari") > -1 && window.navigator.userAgent.indexOf("Chrome") < 0,
    ...
    function setFocus(instance, resetTarget) {
      ...
      if (resetTarget) {
        ...
        if (
          ...
          ((typeof element === "undefined" || element === null) && instance.__internal.buttons.length === 0)
        ) {
          element = instance.elements.reset[0];
        }
        // focus
    ...
    return {
      ...
      show: function (modal, className) {
        ...
        if (!this.__internal.isOpen) {
          ...
          this.__internal.timerIn = deltaTimeout(
      ...
      close: function () {
        if (this.__internal.isOpen) {
          ...
          if (dispatchEvent("onclosing", this) !== false) {
            ...
            this.__internal.timerOut = deltaTimeout(
  ...
  var notifier = (function () {
    ...
    function initialize(instance) {
      if (!instance.__internal) {
        ...
        var transitionOff =
          "transitionOff" in defaults.notifier ? defaults.notifier.transitionOff : defaults.transitionOff;
        if (transitionOff) {
      ...
      return initialize({
          ...
          if (this.__internal.pushed) {
            ...
            if (!(typeof this.ondismiss === "function" && this.ondismiss.call(this) === false)) {
              ...
              if (typeof this.element !== "undefined" && this.element.parentNode === element) {
                ...
                this.__internal.transitionTimeout = deltaTimeout(
        ...
        delay: function (wait) {
          ...
          if (this.__internal.delay > 0) {
            var self = this;
            this.__internal.timer = deltaTimeout(function () {
              self.dismiss();
    ...
    return {
      ...
      create: function (type, callback) {
        ...
        div.className =
          classes.message + (typeof type === "string" && type !== "" ? " " + classes.prefix + type : "");

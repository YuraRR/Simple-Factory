...
!(function (a) {
      ...
      dialog: function (d, e, f, g) {
        ...
        this[d] = f
          ? function () {
              ...
              return (
                b && "function" == typeof b.__init && b.__init(b), b.main.apply(b, arguments), b.show.apply(b)
              );
            }
          : function () {
              if (
  ...
  var n = ":not(:disabled):not(.ajs-reset)",
    ...
    p = {
      ...
      transition: "pulse",
      transitionOff: !1,
      tabbable: ["button", "[href]", "input", "select", "textarea", '[tabindex]:not([tabindex^="-"])' + n].join(
        n + ","
      ),
      notifier: {
        delay: 5,
  ...
  var t = function (a, b, c, d, e) {
    ...
    w = (function () {
      function m(a) {
        if (!a.__internal) {
          ...
          (l.root = document.createElement("div")),
            ...
            (l.dialog.innerHTML =
              Ga.reset + Ga.commands + Ga.header + Ga.body + Ga.footer + Ga.resizeHandle + Ga.reset),
            (l.reset = []),
      ...
      function D(a, b) {
        ...
        return (
          document.body.lastChild !== b.elements.root &&
            (document.body.appendChild(b.elements.root), q.splice(q.indexOf(b), 1), q.push(b), Y(b)),
          !1
        );
      }
      function E(a, d, e, f) {
        switch (d) {
          ...
          case "padding":
            f
              ...
              : a.elements.root.className.indexOf(Ha.noPadding) < 0 && b(a.elements.root, Ha.noPadding);
            break;
          case "overflow":
            f
              ? c(a.elements.root, Ha.noOverflow)
              : a.elements.root.className.indexOf(Ha.noOverflow) < 0 && b(a.elements.root, Ha.noOverflow);
            break;
          case "transition":
            x(a, f, e);
            break;
          ...
          switch (typeof c.element) {
            case "number":
              a.__internal.buttons.length > c.element &&
                (d = !0 === a.get("basic") ? a.elements.reset[0] : a.__internal.buttons[c.element].element);
              break;
            case "string":
      ...
      function ka(a, c) {
        if (!c.isMaximized()) {
          var d;
          if (
            ("touchstart" === a.type ? (a.preventDefault(), (d = a.targetTouches[0])) : 0 === a.button && (d = a),
            d)
          ) {
    ...
    x = (function () {
      function d(a) {
        if (!a.__internal) {
          (a.__internal = { position: y.defaults.notifier.position, delay: y.defaults.notifier.delay }),
  ...
  y.dialog("alert", function () {
    ...
    y.dialog("confirm", function () {
      function a(a) {
        null !== c.timer &&
          (clearInterval(c.timer), (c.timer = null), (a.__internal.buttons[c.index].element.innerHTML = c.text));
      }
      function b(b, d, e) {
        a(b),
          (c.duration = e),
      ...
      var c = {
        ...
        task: function (b, d) {
          if (d.isOpen()) {
            if (
              ((d.__internal.buttons[c.index].element.innerHTML = c.text + " (&#8207;" + c.duration + "&#8207;) "),
              (c.duration -= 1),
              -1 === c.duration)
            ) {
              a(d);
          ...
          switch (a) {
            ...
            case "labels":
              "ok" in c &&
                ...
                ((this.__internal.buttons[0].text = c.ok), (this.__internal.buttons[0].element.innerHTML = c.ok)),
                "cancel" in c &&

      ...
      listeners: {
        ...
        "auto-start:check": function (t) {
          ...
          if (
            i &&
            i.enabled &&
            (!e.pointerIsDown || !/mouse|pointer/.test(e.pointerType) || 0 != (r & n.options.drag.mouseButtons))
          )
            return (t.action = { name: "drag", axis: "start" === i.lockAxis ? i.startAxis : i.lockAxis }), !1;
        },
      },
    ...
    return (
      ...
      r.rejected ||
        (r.cur.element !== r.prev.element &&
          ...
          r.cur.dropzone &&
            ((i.enter = new xt(r, n, "dragenter")), (n.dragEnter = r.cur.element), (n.dropzone = r.cur.dropzone))),
        "dragend" === n.type &&
          r.cur.dropzone &&
              ...
              if (w.object(e)) {
                ...
                return (
                  ...
                  /^(pointer|center)$/.test(e.overlap)
                    ...
                    : w.number(e.overlap) && (t.options.drop.overlap = Math.max(Math.min(1, e.overlap), 0)),
      ...
      listeners: {
        ...
        "interactions:action-end": function (t, e) {
          if ("drag" === t.interaction.prepared.name) {
            var n = t.interaction,
              r = t.iEvent;
            Pt(t, e), _t(n, n.dropState.events), e.fire("actions/drop:end", { interaction: n, dragEvent: r });
          }
        },
          ...
          if (i) {
            ...
            if (
              ...
              if (w.object(s.edges)) {
                ...
                for (var l in c)
                  c[l] = zt(l, s.edges[l], a, e._latestPointer.eventTarget, r, i, s.margin || jt.defaultMargin);
                (c.left = c.left && !c.right),
                  (c.top = c.top && !c.bottom),
                  (c.left || c.right || c.top || c.bottom) && (t.action = { name: "resize", edges: c });
              } else {
    ...
    scroll: function () {
      ...
      if (c >= 1) {
        ...
        if (l.x || l.y) {
          ...
          (f.x || f.y) &&
            e.fire({ type: "autoscroll", target: n, interactable: e, delta: f, interaction: t, container: o });
        }
        qt.prevTime = a;
      }
      ...
      "autoStart:before-start": function (t, e) {
        ...
        if ("drag" === n.prepared.name) {
          var a = Math.abs(i),
            ...
            u = a > s ? "x" : a < s ? "y" : "xy";
          if (
            ((n.prepared.axis = "start" === c.lockAxis ? u[0] : c.lockAxis), "xy" !== u && "xy" !== l && l !== u)
          ) {
      ...
      listeners: {
        ...
        "autoStart:prepared": function (t) {
          var e = t.interaction,
            n = ce(e);
          n > 0 &&
            (e.autoStartHoldTimer = deltaTimeout(function () {
            ...
            if ("never" !== r)
              if ("always" !== r) {
                ...
                /^(mouse|pointer|touch)*(down|start)/i.test(n.type) ||
                  (w.element(n.target) &&
                    R(n.target, "input,select,textarea,[contenteditable=true],[contenteditable=true] *")) ||
                  n.preventDefault();
          ...
          value: function (t, e) {
            ...
            this.prepareStates(a),
              ...
              (this.startOffset =
                ...
                (r = e),
                n
                  ? { left: r.x - n.left, top: r.y - n.top, right: n.right - r.x, bottom: n.bottom - r.y }
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (this.states && this.states.length) {
              var n = V({ states: this.states, interactable: e.interactable, element: e.element, rect: null }, t);
              this.fillArg(n);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (this._ending = !0),
                ...
                this.interacting() && (e = this._doPhase({ event: t, interaction: this, phase: "end" })),
                (this._ending = !1),
                !0 === e && this.stop();
            },
          },
          ...
          },
          {
            ...
            value: function (t, e, n, r) {
              ...
              return (
                ...
                l
                  ? (l.pointer = t)
                  : ((l = new _e(s, t, e, null, null)), (c = this.pointers.length), this.pointers.push(l)),
                st(
                  this.coords.cur,
      ...
      o(t, [
        {
          ...
          value: function (t) {
            ...
            if (
              ...
              (this.modifierArg = o.fillArg({ pageCoords: this.startCoords, preEnd: !0, phase: "inertiastart" })),
              ...
              for (var r in e) {
                ...
                "listeners" === i && this.updatePerActionListeners(t, o.listeners, a),
                  w.array(a)
                    ...
                    : w.plainObject(a)
                    ? ((o[i] = V(o[i] || {}, ge(a))),
                      w.object(n.perAction[i]) && "enabled" in n.perAction[i] && (o[i].enabled = !1 !== a.enabled))
        ...
        if (i) {
          ...
          (n.options = { endOnly: o.endOnly, inner: V({}, On.noInner), outer: V({}, On.noOuter) }),
            i.top
              ...
              : i.bottom &&
                ((n.options.inner.bottom = r.top + a.height), (n.options.outer.bottom = r.top + s.height)),
            i.left
        ...
        for (
          ...
          E === 1 / 0 && y.inRange && y.range !== 1 / 0 && (P = !1),
            (y.target &&
              ...
              ((y.target = x), (y.distance = _), (y.range = E), (y.inRange = P), (y.delta.x = T), (y.delta.y = S));
        }
      ...
      listeners: {
        ...
        "interactions:down": function (t, e) {
          !(function (t, e) {
            ...
            (s.duration = f),
              (s.timeout = deltaTimeout(function () {
          ...
          Gn(t),
            ...
            (function (t, e) {
              var n = t.interaction,
                ...
                i = t.event,
                o = t.eventTarget;
              n.pointerWasMoved || Vn({ interaction: n, eventTarget: o, pointer: r, event: i, type: "tap" }, e);
            })(t, e);
        },
        ...
        },
        {
          ...
          "pointerEvents:fired": function (t, e) {
            ...
            if ("hold" === r.type && o.length) {
              ...
              a <= 0 ||
                (n.holdIntervalHandle = deltaTimeout(function () {
                  ...
                  a = function () {
                    ...
                    var l,
                      u = bt(n.interactions.list, function (n) {
                        return (
                          n.interacting() && n.interactable === t && n.element === a && n.prepared.name === e.name
                        );
                      });
                    if (u)
                      u.move(),
                      ...
                      var p = U(c),
                        ...
                        })({ page: { x: p.x, y: p.y }, client: { x: p.x, y: p.y }, timeStamp: n.now() });
                      l = (function (t, e, n, r, i) {
                        var o = t.interactions.new({ pointerType: "reflow" }),
                          a = { interaction: o, event: i, pointer: i, eventTarget: n, phase: "reflow" };
                        (o.interactable = e),
                          (o.element = n),
                          (o.prevEvent = i),
